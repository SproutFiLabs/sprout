...
sr=48000; dur=30; n=sr*dur; mix=np.zeros((n,2)); rng=np.random.default_rng(19092026)
...
cuts=[3,9,15,21,27]
events=[(t,'whoosh') for t in cuts]+[(.4,'bloom'),(7.3,'tap'),(10.25,'tap'),(12,'confirm'),(18.5,'tap'),(21.2,'bloom'),(23.3,'confirm'),(25.1,'tap'),(27.2,'resolve')]
...
p=Path(__file__).parent;out=p/'public/audio/score.wav'
...
(p/'audio-cues.json').write_text(json.dumps(events,indent=2));print('Original 30-second stereo score and synchronized sound effects rendered.')
