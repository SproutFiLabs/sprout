...
export const zh: Record<string, string> = {
  ...
  '100 big tech-heavy companies|holding': '以科技公司为主的 100 家大公司',
  'Google|holding': '谷歌公司',
  'Amazon|holding': '亚马逊公司',
  'Meta|holding': 'Meta 公司',
  'Alibaba|holding': '阿里巴巴',
  'SpaceX|holding': 'SpaceX 公司',
  'Tesla|holding': '特斯拉公司',
  'Palantir|holding': 'Palantir 公司',
  'AMD|holding': 'AMD 公司',
  'TSMC|holding': '台积电',
  'ASML|holding': '阿斯麦公司',
  'Micron|holding': '美光公司',
  'Intel|holding': '英特尔公司',
  'Sandisk|holding': '闪迪公司',
  'a silver fund|holding': '一只白银基金',
  'an oil fund|holding': '一只原油基金',
  'GameStop|holding': '游戏驿站公司',
  ...
  // Private kid view, opened from an expiring invitation (KidView.tsx)
  'Your private sprout': '你的私密小芽',
  'Your own little window': '你专属的小窗口',
  'Your little world.': '你的小小世界。',
  'Growing every day.': '每天都在长大。',
  'Opening your invitation…': '正在打开你的邀请……',
  'A future in bloom': '正在开花的未来',
  'Your grown-up chose to share this balance with you.': '照顾你的大人选择让你看到这个余额。',
  'Your money is tucked away. Your curiosity can grow.': '你的钱被好好收着呢。你的好奇心可以尽情长大。',
  'Only on your invited device': '只在你受邀的设备上显示',
  'Amounts stay with your grown-up': '金额只有照顾你的大人能看到',
  'A little piece of the world': '世界的一小份',
  'Explore the companies your sprout follows.': '去认识一下你的小芽跟着的这些公司吧。',
  'Learn what makes this company grow': '了解这家公司是怎么成长的',
  'Yours to explore': '等你来探索',
  'Discover what makes your sprout grow. Your grown-up takes care of the money.': '发现是什么让你的小芽长大。钱的事交给照顾你的大人。',
  '{n} chore waiting for a grown-up’s approval.': '有 {n} 项家务在等大人确认。',
  '{n} chores waiting for a grown-up’s approval.': '有 {n} 项家务在等大人确认。',
  'A grown-up can close this window at any time.': '大人随时可以关掉这个窗口。',
  // Kid view errors, shown through t(error) (thrown in KidView.tsx and by kidRequest in api.ts)
  'This old link is retired. Ask a grown-up for a private invitation.': '这个旧链接已经不能用了。请找大人要一个私密邀请。',
  'Ask a grown-up for a new invitation.': '请找大人要一个新的邀请。',
  'This invitation has ended. Ask a grown-up for a new one.': '这个邀请已经结束了。请找大人要一个新的。',
  'This view is unavailable.': '现在打不开这个页面。',
