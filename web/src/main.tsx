...
function Root() {
  ...
  if (/^\/grow\/(events|roundups|cash|arena)$/.test(path)) return <Suspense fallback={<main style={{padding:64}}>Opening your growing world…</main>}><ExpansionPage page={path.split('/')[2] as 'events'|'roundups'|'arena'|'cash'|'continuity'}/></Suspense>;
