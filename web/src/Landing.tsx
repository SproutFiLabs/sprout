            ...
            <div className="reference-create">
              ...
              {role === 2 ? (
                ...
                <form className="create-form" onSubmit={plantFromForm}>
                  <input name="nickname" aria-label={t('Your sprout’s nickname')} placeholder={t('Your sprout’s nickname')} required maxLength={24} />
        ...
        <div className="wrap">
          ...
          <footer className="reference-footer">
            ...
            <div className="reference-footer-links">
              <div><span>SPROUT</span><a href={DASHBOARD}>{t('Dashboard')}</a><a href={`${DASHBOARD}?new=1`}>{t('Plant a sprout')}</a><a href="/gift">{t('Gift preview')}</a></div>
