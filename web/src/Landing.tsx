          ...
          <div className="reference-resources">
            ...
            {resources ? (
              <nav className="resource-menu" aria-label={t('Explore SPROUT')}>
                ...
                <a href="/whitepaper">{t('Whitepaper')}</a><a href="/tokenomics">{t('Tokenomics')}</a><a href="/tools">{t('Premium tools')}</a>
        ...
        <div className="wrap">
          ...
          <footer className="reference-footer">
            ...
            <div className="reference-footer-links">
              ...
              <div><span>{t('Learn')}</span><a href="/faq">{t('Questions')}</a><a href="/guide">{t('Getting started')}</a><a href="/docs">{t('Documentation')}</a><a href="/whitepaper">{t('Whitepaper')}</a><a href="/tokenomics">{t('Tokenomics')}</a><a href="/tools">{t('Premium tools')}</a><a href="/settings">{t('Appearance')}</a></div>
            </div>
          </footer>
        </div>
      </div>
