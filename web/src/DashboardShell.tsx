            ...
            <>
              ...
              {selected && !isSample ? (
                <div className="garden-kid-link">
                  ...
                  <p className="garden-empty-note">
                    {t('A read-only page {name} can open on any device to watch their sprout grow: what it holds, chores and rewards, and how long until it’s theirs. It can’t move money. The link includes the name you gave this sprout.', { name: nameFor(selected.id) })}
                  </p>
